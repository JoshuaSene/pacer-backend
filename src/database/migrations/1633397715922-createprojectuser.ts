...
export class createprojectuser1633397715922 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE \`pacer\`.\`project_user\` (\`id_user\` char(36) NOT NULL, \`id_project\` char(36) NOT NULL, \`optional\` tinyint NOT NULL, \`sn_activated\` varchar(255) NOT NULL, PRIMARY KEY (\`id_user\`, \`id_project\`)) ENGINE=InnoDB`);
